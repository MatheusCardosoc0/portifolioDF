  ...
  return (
    <footer className=' p-4 bg-gradient-to-t from-teal-400 to-black items-center '>
      <h2 className='text-3xl md:text-4xl font-bold underline decoration-amber-500 text-white drop-shadow-[1px_1px_30px_teal]'>
        <p className='drop-shadow-[1px_1px_30px_yellow] text-5xl text-center md:mb-4 mb-8' id='contact'>
          Contato
        </p>
      </h2>
      <div className='flex flex-col gap-20 mt-20'>
        <div className='md:text-2xl text-xl text-white font-bold drop-shadow-[1px_1px_1px_black] flex flex-col md:gap-2 w-full items-start justify-center max-w-[400px] mx-auto'>
          <p>
        ...
        <div className='flex text-7xl gap-4 justify-center md:justify-'>
